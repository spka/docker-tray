...
```bash
curl -fLO https://github.com/spka/docker-tray/releases/download/v0.2.15/docker-tray_0.2.15_all.deb
curl -fLO https://github.com/spka/docker-tray/releases/download/v0.2.15/docker-tray_0.2.15_all.deb.sha256
sha256sum --check docker-tray_0.2.15_all.deb.sha256
sudo apt install ./docker-tray_0.2.15_all.deb
```
