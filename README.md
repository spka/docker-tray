...
curl -L -o /tmp/docker-tray_0.2.0_all.deb https://github.com/spka/docker-tray/releases/download/v0.2.0/docker-tray_0.2.0_all.deb

# Make the file readable by apt's sandbox user.
chmod 0644 /tmp/docker-tray_0.2.0_all.deb

# Install or upgrade Docker Tray.
sudo apt install /tmp/docker-tray_0.2.0_all.deb

# Remove the temporary package file.
rm /tmp/docker-tray_0.2.0_all.deb
```
