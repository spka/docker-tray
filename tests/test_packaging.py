...
class PackagingTests(unittest.TestCase):
    def test_versions_match(self):
        self.assertEqual("0.2.13", docker_tray.APP_VERSION)
        self.assertIn("pkgver=0.2.7", (ROOT / "packaging/arch/PKGBUILD").read_text())
        self.assertIn('version="${1:-0.2.13}"', (ROOT / "package-deb.sh").read_text())
    ...
    def test_release_version_script_accepts_current_tag(self):
        ...
        self.assertEqual("0.2.13", result.stdout.strip())
